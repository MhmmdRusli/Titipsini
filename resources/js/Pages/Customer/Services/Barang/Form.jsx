...
import { Package, ShieldCheck, Calendar } from 'lucide-react';
    ...
    return (
        <CustomerLayout title="Pilih Paket" backHref="/app/services/barang/paket-pilihan">
            ...
            <div className="px-4 py-3">
                {/* Kartu ringkasan - sama seperti di halaman Pilih Paket sebelumnya */}
                ...
                <form onSubmit={handleSubmit} className="mt-6 space-y-5">
                    <div>
                        <label className="text-sm font-bold text-gray-900">Barang</label>
                        <input
                            type="text"
                    ...
                    <div className="flex items-center justify-between">
                        <label className="text-sm font-bold text-gray-900">Pick up</label>
                        <button
                            type="button"
                            onClick={() => update('pickup', !form.pickup)}
                            className={`relative h-6 w-11 shrink-0 rounded-full transition ${
                                form.pickup ? 'bg-green-600' : 'bg-gray-200'
                            }`}
                        >
                            <span
                    ...
                    <div>
                        ...
                        <div className="relative mt-2">
                            <input
                                ...
                                className="w-full rounded-xl border border-gray-200 bg-white px-4 py-3 text-sm text-gray-700 shadow-sm focus:outline-none focus:ring-2 focus:ring-green-500"
                            />
                        </div>
                    </div>
