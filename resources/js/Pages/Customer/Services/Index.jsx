            ...
            <div className={`px-4 py-3 ${modalOpen ? 'pointer-events-none blur-sm' : ''}`}>
                <form onSubmit={handleSearchSubmit} className="relative">
                    ...
                    <input
                        ...
                        className="w-full rounded-full border border-gray-200 bg-white py-2.5 pl-9 pr-4 text-sm text-gray-700 shadow-sm focus:outline-none focus:ring-2 focus:ring-brand-teal-500"
                    />
                </form>
                ...
                <div className="mt-4 grid grid-cols-2 gap-3">
                    {services.data.length === 0 && (
                        <div className="col-span-2 rounded-xl border border-dashed border-gray-300 p-6 text-center text-sm text-gray-400">
                    ...
                    {services.data.map((service) => (
                        ...
                        >
                            ...
                            <div className="p-2.5">
                                <p className="truncate text-xs font-semibold text-gray-900">{service.kota}</p>
                                ...
                                <button
                                    ...
                                    className={`rounded-full border px-4 py-2 text-sm font-medium transition ${
                                        selectedType === type.value
                                            ...
                                            : 'border-gray-200 text-gray-600 hover:border-brand-teal-300'
                                    }`}
                                >
                                    {type.label}
                                </button>
