        ...
        <CustomerLayout title="Status Top Up" backHref="/app/dashboard">
            ...
            <div className="px-4 py-6">
                <div className="rounded-2xl border border-gray-100 bg-white p-5 text-center shadow-sm">
                    ...
                    <p className="mt-3 text-lg font-bold text-gray-900">Menunggu Verifikasi</p>
                    <p className="mt-1 text-xs text-gray-500">
                        Bukti pembayaran kamu sedang diperiksa oleh tim kami. Biasanya kurang dari 10 menit.
                    </p>
                    <p className="mt-2 text-xs text-gray-400">ID Transaksi {topup.kode_transaksi}</p>

                    <div className="mt-3 rounded-xl bg-amber-50 px-4 py-3">
                        <p className="text-xs text-amber-700">Nominal Top Up</p>
                        <p className="text-xl font-bold text-amber-800">{formatRupiah(topup.nominal)}</p>
                    </div>
                </div>
